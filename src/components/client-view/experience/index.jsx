...
export default function ClientExperienceAndEcucationView({
  educationData,
  experienceData,
}) {
  ...
  return (
    <div
      className="max-w-screen-xl mt-52 mb-6 sm:mt-14 ms:mb-14 px-6 sm:px-8 lg:px-16 mx-auto"
      id="experience"
    >
                  ...
                  {experienceData && experienceData.length
                    ? experienceData.map((experienceItem) => (
                        <TimelineItem>
                          ...
                          <TimelineContent>
                            <div className="border-[2px] px-4 rounded-[8px] border-green-main mt-[14px] ml-[16px]">
